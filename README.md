...
Another example of a mixture model. The do syntax is really just for readbility, the DSL parses it differently to prevent variable boxing and Enzyme having a bad time.
